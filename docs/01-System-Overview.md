...
BACKEND (Java 21 + Spring Boot)
  ├── REST API Layer  (/api/issuer/*, /api/holder/*, /api/verifier/*, /api/admin/*)
  ├── Service Layer   (Issuer, Holder, Verification, Credential)
  ├── Core Services   (Canonicalization, Crypto, IPFS, KeyStore, Revocation)
  └── Storage Layer   (PostgreSQL, Local IPFS, PKCS12 KeyStore)
```
